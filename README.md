...
| Sun 5/30/21 | In flipping branch changed Player display and customizability, while refining the flipping in AAS | Refactored Main code, restructured Button class hierarchy, created FixLyreScene, added more input handlers for Scenes |
